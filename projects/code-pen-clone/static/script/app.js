...
<body>
    ...
    htmlEditor.session.setValue(localStorage.getItem('lc-codepen-clone-html'));
  ...
  else jsEditor.session.setValue(localStorage.getItem('lc-codepen-clone-js'));
  ...
  function changeLayout() {
    switch (layout) {
      case 0:
        ...
        for (
          var i = 0;
          i < document.getElementsByClassName('code').length;
          i++
        ) {
